...
System.register('reflar/auth-gitlab/main', ['flarum/extend', 'flarum/app', 'flarum/components/LogInButtons', 'flarum/components/LogInButton'], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      app.initializers.add('reflar/auth-gitlab', function () {
